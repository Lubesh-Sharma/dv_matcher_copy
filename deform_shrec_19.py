...
def eval_net(cfg):
    ...
    # SHREC_19 specific paths
    shape1_pth = "data/shrec_19/shapes_train/1.off"
    shape2_pth = "data/shrec_19/shapes_test/36.off"
    name1 = "1"
    name2 = "36"         
    with torch.no_grad():
        point_backbone_dino.eval() 
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Launch the deformation for SHREC_19 dataset.")
    parser.add_argument('--savedir', required=False, default="./data", help='root directory of the dataset')
    parser.add_argument("--config", type=str, default="deform_shrec_19", help="Config file name")
